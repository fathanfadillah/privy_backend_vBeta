                            ...
                            <div class="form-row form-inline">
                                <div class="col-md-12">
                                    <div class="form-group m-0">
                                        <label for="nm_penduduk" class="col-form-label s-12 col-md-4">Nama</label>
                                        <input type="text" name="nm_penduduk" id="nm_penduduk" placeholder="" class="form-control r-0 light s-12 col-md-8" autocomplete="off" required/>
                                    </div>
                                    <!-- <div class="form-group m-0">
                                    ...
                                    <div class="form-group m-0">
                                        ...
                                        <input type="text" name="no_ktp" id="no_ktp" placeholder="" class="form-control r-0 light s-12 col-md-8" autocomplete="off" required/>
                                    </div>
                                    <!-- <div class="form-group m-0">
...
<script type="text/javascript">
    var table = $('#dataTable').dataTable({
        ...
        columns: [
            ...
            {data: 'nm_penduduk', name: 'nm_penduduk'},
    ...
    function edit(id) {
        ...
        $.get("{{ route($route.'edit', ':id') }}".replace(':id', id), function(data){
            $('#id').val(data.id);
            $('#nm_penduduk').val(data.nm_penduduk).focus();
