    ...
    <div id="app">
        <aside class="main-sidebar fixed offcanvas shadow" data-toggle='offcanvas'>
            <section class="sidebar">
                <div class=" mt-3 mb-3">
                    <img src="{{ asset('images/logo/'.$template->logo) }}" class="mx-auto d-block" width="100"
                        alt="Logo Top">
                </div>
                <div class="relative">
                    ...
                    <div class="user-panel p-3 light mb-2">
                        <div>
                            <div class="float-left image ml-2">
                                <img class="rounded-circle img-circular mr-3" width="60" height="60"
                                    src="{{ asset('images/ava/' . Auth::user()->admin_detail[0]->foto) }}"
                                    alt="User Image">
                            </div>
                        ...
                        <div class="collapse multi-collapse" id="userSettingsCollapse">
                            <div class="list-group mt-3 shadow">
                                ...
                                @endcan
                                <a href="{{ route('master-profile.profile.editPassword', Auth::user()->admin_detail[0]->id) }}"
                                    class="list-group-item list-group-item-action">
